    ...
    nodes: [
      ...
      },
      {
        ...
        graph: {
          ...
          links: [
            { from: "正方", to: "反方", trigger_type: "continue", message_type: "last" },
            { from: "反方", to: "正方", trigger_type: "continue", message_type: "last" },
            { from: "正方", to: "裁决总结", trigger_type: "complete", message_type: "last" },
            { from: "反方", to: "裁决总结", trigger_type: "complete", message_type: "last" },
          ],
        },
      },
    ],
    links: [
      { from: "初筛", to: "辩论", trigger_type: "transfer", message_type: "last" },
      { from: "辩论", to: "初筛", trigger_type: "transfer", message_type: "last" },
    ],
  });
