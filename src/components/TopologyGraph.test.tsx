...
test("拓扑只展示有可展示消息记录的 agent，并基于过滤后的节点重新布局", () => {
  ...
  assert.match(TOPOLOGY_GRAPH_SOURCE, /getTopologyCanvasViewportMeasurementKey\(/);
  assert.match(TOPOLOGY_GRAPH_SOURCE, /hasRenderableCanvas: Boolean\(topology && visibleNodeIds\.length > 0\)/);
